...
import org.cru.godtools.api.scarlet.MobileContentApiRequestFactory
...
object ApiModule {
    ...
    fun actionCableScarlet(
        ...
        .webSocketFactory(okhttp.newWebSocketFactory(MobileContentApiRequestFactory("${baseUrl}cable")))
